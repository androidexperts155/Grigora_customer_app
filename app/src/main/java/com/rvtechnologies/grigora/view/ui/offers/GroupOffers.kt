...
import com.rvtechnologies.grigora.databinding.GroupOfferFragmentBinding
...
import com.rvtechnologies.grigora.view.ui.groupCart.GroupCartViewModel
...
class GroupOffers : Fragment(), IRecyclerItemClick {
...
//            viewModel.select(item)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = activity?.run {
            ViewModelProviders.of(this).get(GroupCartViewModel::class.java)
    ...
    override fun onCreateView(
        ...
        val offerFragmentBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.group_offer_fragment,
            container,
            false
        ) as GroupOfferFragmentBinding
